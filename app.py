...
MODEL_NAME = 'ann.npz' #path for saving parameters
class ANN():
    def __init__(self):
...
data = {}
size = -1
if not os.path.exists(MODEL_PATH): #only train when parameters was not saved or have not been trained before
